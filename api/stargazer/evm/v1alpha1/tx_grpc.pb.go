...
const (
	MsgService_EthTransaction_FullMethodName = "/stargazer.evm.v1alpha1.MsgService/EthTransaction"
	MsgService_UpdateParams_FullMethodName   = "/stargazer.evm.v1alpha1.MsgService/UpdateParams"
)
