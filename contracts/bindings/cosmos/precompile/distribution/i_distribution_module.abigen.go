...
//
// Solidity: function getWithdrawAddress(address delegtor) view returns(address)
func (_DistributionModule *DistributionModuleCaller) GetWithdrawAddress(opts *bind.CallOpts, delegtor common.Address) (common.Address, error) {
	var out []interface{}
	err := _DistributionModule.contract.Call(opts, &out, "getWithdrawAddress", delegtor)
...
//
// Solidity: function getWithdrawAddress(address delegtor) view returns(address)
func (_DistributionModule *DistributionModuleSession) GetWithdrawAddress(delegtor common.Address) (common.Address, error) {
	return _DistributionModule.Contract.GetWithdrawAddress(&_DistributionModule.CallOpts, delegtor)
}

// GetWithdrawAddress is a free data retrieval call binding the contract method 0xafe46ea2.
//
// Solidity: function getWithdrawAddress(address delegtor) view returns(address)
func (_DistributionModule *DistributionModuleCallerSession) GetWithdrawAddress(delegtor common.Address) (common.Address, error) {
	return _DistributionModule.Contract.GetWithdrawAddress(&_DistributionModule.CallOpts, delegtor)
}
