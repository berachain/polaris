...
// DelegateNoReturn is a paid mutator transaction binding the contract method 0x10af8ad5.
//
// Solidity: function delegateNoReturn(address validatorAddress, uint256 amount) payable returns()
func (_StakingModule *StakingModuleTransactor) DelegateNoReturn(opts *bind.TransactOpts, validatorAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakingModule.contract.Transact(opts, "delegateNoReturn", validatorAddress, amount)
}

// DelegateNoReturn is a paid mutator transaction binding the contract method 0x10af8ad5.
//
// Solidity: function delegateNoReturn(address validatorAddress, uint256 amount) payable returns()
func (_StakingModule *StakingModuleSession) DelegateNoReturn(validatorAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakingModule.Contract.DelegateNoReturn(&_StakingModule.TransactOpts, validatorAddress, amount)
}

// DelegateNoReturn is a paid mutator transaction binding the contract method 0x10af8ad5.
//
// Solidity: function delegateNoReturn(address validatorAddress, uint256 amount) payable returns()
func (_StakingModule *StakingModuleTransactorSession) DelegateNoReturn(validatorAddress common.Address, amount *big.Int) (*types.Transaction, error) {
	return _StakingModule.Contract.DelegateNoReturn(&_StakingModule.TransactOpts, validatorAddress, amount)
}
