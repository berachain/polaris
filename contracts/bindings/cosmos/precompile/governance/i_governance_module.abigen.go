...
//
// Solidity: function getProposals(int32 proposalStatus, (string,uint64,uint64,bool,bool) pagination) view returns((uint64,(string,uint8[])[],int32,(string,string,string,string),uint64,uint64,(uint256,string)[],uint64,uint64,string,string,string,address)[], (string,uint64))
...
// SubmitProposal is a paid mutator transaction binding the contract method 0xe4112572.
//
// Solidity: function submitProposal(((string,uint8[])[],(uint256,string)[],address,string,string,string,bool) proposal) returns(uint64)
