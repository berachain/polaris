...
//
// Solidity: function submitProposal(bytes proposal) returns(uint64)
func (_GovernanceModule *GovernanceModuleTransactor) SubmitProposal(opts *bind.TransactOpts, proposal []byte) (*types.Transaction, error) {
...
//
// Solidity: function submitProposal(bytes proposal) returns(uint64)
func (_GovernanceModule *GovernanceModuleSession) SubmitProposal(proposal []byte) (*types.Transaction, error) {
...
//
// Solidity: function submitProposal(bytes proposal) returns(uint64)
func (_GovernanceModule *GovernanceModuleTransactorSession) SubmitProposal(proposal []byte) (*types.Transaction, error) {
	return _GovernanceModule.Contract.SubmitProposal(&_GovernanceModule.TransactOpts, proposal)
}
