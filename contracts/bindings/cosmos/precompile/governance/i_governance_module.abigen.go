...
func (_GovernanceModule *GovernanceModuleCaller) GetProposals(opts *bind.CallOpts, proposalStatus int32, pageRequest CosmosPageRequest) ([]IGovernanceModuleProposal, CosmosPageResponse, error) {
	var out []interface{}
	err := _GovernanceModule.contract.Call(opts, &out, "getProposals", proposalStatus, pageRequest)
...
//
// Solidity: function getProposals(int32 proposalStatus, (string,uint64,uint64,bool,bool) pageRequest) view returns((uint64,bytes,int32,(string,string,string,string),uint64,uint64,(uint256,string)[],uint64,uint64,string,string,string,string)[], (string,uint64))
func (_GovernanceModule *GovernanceModuleSession) GetProposals(proposalStatus int32, pageRequest CosmosPageRequest) ([]IGovernanceModuleProposal, CosmosPageResponse, error) {
	return _GovernanceModule.Contract.GetProposals(&_GovernanceModule.CallOpts, proposalStatus, pageRequest)
}

// GetProposals is a free data retrieval call binding the contract method 0x917c9d92.
//
// Solidity: function getProposals(int32 proposalStatus, (string,uint64,uint64,bool,bool) pageRequest) view returns((uint64,bytes,int32,(string,string,string,string),uint64,uint64,(uint256,string)[],uint64,uint64,string,string,string,string)[], (string,uint64))
func (_GovernanceModule *GovernanceModuleCallerSession) GetProposals(proposalStatus int32, pageRequest CosmosPageRequest) ([]IGovernanceModuleProposal, CosmosPageResponse, error) {
	return _GovernanceModule.Contract.GetProposals(&_GovernanceModule.CallOpts, proposalStatus, pageRequest)
}
