...
// GetGetValAddressFromConsAddress is a free data retrieval call binding the contract method 0x377dd205.
//
// Solidity: function getGetValAddressFromConsAddress(bytes consAddr) pure returns(address)
func (_StakingModule *StakingModuleCaller) GetGetValAddressFromConsAddress(opts *bind.CallOpts, consAddr []byte) (common.Address, error) {
	var out []interface{}
	err := _StakingModule.contract.Call(opts, &out, "getGetValAddressFromConsAddress", consAddr)
...
//
// Solidity: function getGetValAddressFromConsAddress(bytes consAddr) pure returns(address)
func (_StakingModule *StakingModuleSession) GetGetValAddressFromConsAddress(consAddr []byte) (common.Address, error) {
	return _StakingModule.Contract.GetGetValAddressFromConsAddress(&_StakingModule.CallOpts, consAddr)
}

// GetGetValAddressFromConsAddress is a free data retrieval call binding the contract method 0x377dd205.
//
// Solidity: function getGetValAddressFromConsAddress(bytes consAddr) pure returns(address)
func (_StakingModule *StakingModuleCallerSession) GetGetValAddressFromConsAddress(consAddr []byte) (common.Address, error) {
	return _StakingModule.Contract.GetGetValAddressFromConsAddress(&_StakingModule.CallOpts, consAddr)
}
