...
func (_StakingModule *StakingModuleCaller) GetActiveValidators(opts *bind.CallOpts, pageRequest CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	var out []interface{}
	err := _StakingModule.contract.Call(opts, &out, "getActiveValidators", pageRequest)
...
//
// Solidity: function getActiveValidators((string,uint64,uint64,bool,bool) pageRequest) view returns(address[], (string,uint64))
func (_StakingModule *StakingModuleSession) GetActiveValidators(pageRequest CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetActiveValidators(&_StakingModule.CallOpts, pageRequest)
}

// GetActiveValidators is a free data retrieval call binding the contract method 0x1b4d8146.
//
// Solidity: function getActiveValidators((string,uint64,uint64,bool,bool) pageRequest) view returns(address[], (string,uint64))
func (_StakingModule *StakingModuleCallerSession) GetActiveValidators(pageRequest CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetActiveValidators(&_StakingModule.CallOpts, pageRequest)
}
...
//
// Solidity: function getDelegatorValidators(address delegatorAddress, (string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleCaller) GetDelegatorValidators(opts *bind.CallOpts, delegatorAddress common.Address, pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	var out []interface{}
	err := _StakingModule.contract.Call(opts, &out, "getDelegatorValidators", delegatorAddress, pageRequest)
...
//
// Solidity: function getDelegatorValidators(address delegatorAddress, (string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleSession) GetDelegatorValidators(delegatorAddress common.Address, pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetDelegatorValidators(&_StakingModule.CallOpts, delegatorAddress, pageRequest)
}

// GetDelegatorValidators is a free data retrieval call binding the contract method 0xb067c623.
//
// Solidity: function getDelegatorValidators(address delegatorAddress, (string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleCallerSession) GetDelegatorValidators(delegatorAddress common.Address, pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetDelegatorValidators(&_StakingModule.CallOpts, delegatorAddress, pageRequest)
}
...
//
// Solidity: function getValidators((string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleCaller) GetValidators(opts *bind.CallOpts, pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	var out []interface{}
	err := _StakingModule.contract.Call(opts, &out, "getValidators", pageRequest)
...
//
// Solidity: function getValidators((string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleSession) GetValidators(pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetValidators(&_StakingModule.CallOpts, pageRequest)
}

// GetValidators is a free data retrieval call binding the contract method 0xbfc4dcd5.
//
// Solidity: function getValidators((string,uint64,uint64,bool,bool) pageRequest) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
func (_StakingModule *StakingModuleCallerSession) GetValidators(pageRequest CosmosPageRequest) ([]IStakingModuleValidator, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetValidators(&_StakingModule.CallOpts, pageRequest)
}
