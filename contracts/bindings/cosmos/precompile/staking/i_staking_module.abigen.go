...
//
// Solidity: function getActiveValidators((string,uint64,uint64,bool,bool) pagination) view returns(address[], (string,uint64))
func (_StakingModule *StakingModuleCaller) GetActiveValidators(opts *bind.CallOpts, pagination CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	var out []interface{}
	err := _StakingModule.contract.Call(opts, &out, "getActiveValidators", pagination)
...
//
// Solidity: function getActiveValidators((string,uint64,uint64,bool,bool) pagination) view returns(address[], (string,uint64))
func (_StakingModule *StakingModuleSession) GetActiveValidators(pagination CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetActiveValidators(&_StakingModule.CallOpts, pagination)
}

// GetActiveValidators is a free data retrieval call binding the contract method 0x1b4d8146.
//
// Solidity: function getActiveValidators((string,uint64,uint64,bool,bool) pagination) view returns(address[], (string,uint64))
func (_StakingModule *StakingModuleCallerSession) GetActiveValidators(pagination CosmosPageRequest) ([]common.Address, CosmosPageResponse, error) {
	return _StakingModule.Contract.GetActiveValidators(&_StakingModule.CallOpts, pagination)
}
...
//
// Solidity: function getDelegatorValidators(address delegatorAddress, (string,uint64,uint64,bool,bool) pagination) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
...
//
// Solidity: function getValidatorDelegations(address validatorAddress, (string,uint64,uint64,bool,bool) pagination) view returns((address,uint256)[], (string,uint64))
...
//
// Solidity: function getValidators((string,uint64,uint64,bool,bool) pagination) view returns((string,bytes,bool,string,uint256,uint256,(string,string,string,string,string),int64,string,((uint256,uint256,uint256),string),uint256,int64,uint64[])[], (string,uint64))
...
// ValAddressFromConsAddress is a free data retrieval call binding the contract method 0x89f77193.
//
// Solidity: function valAddressFromConsAddress(bytes consAddress) pure returns(address)
func (_StakingModule *StakingModuleCaller) ValAddressFromConsAddress(opts *bind.CallOpts, consAddress []byte) (common.Address, error) {
	var out []interface{}
...
//
// Solidity: function valAddressFromConsAddress(bytes consAddress) pure returns(address)
func (_StakingModule *StakingModuleSession) ValAddressFromConsAddress(consAddress []byte) (common.Address, error) {
...
//
// Solidity: function valAddressFromConsAddress(bytes consAddress) pure returns(address)
func (_StakingModule *StakingModuleCallerSession) ValAddressFromConsAddress(consAddress []byte) (common.Address, error) {
	return _StakingModule.Contract.ValAddressFromConsAddress(&_StakingModule.CallOpts, consAddress)
}
