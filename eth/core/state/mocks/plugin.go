...
func (_m *Plugin) Prepare(_a0 context.Context) {
	_m.Called(_a0)
}

// Plugin_Prepare_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Prepare'
type Plugin_Prepare_Call struct {
	*mock.Call
}

// Prepare is a helper method to define mock.On call
//   - _a0 context.Context
func (_e *Plugin_Expecter) Prepare(_a0 interface{}) *Plugin_Prepare_Call {
	return &Plugin_Prepare_Call{Call: _e.mock.On("Prepare", _a0)}
}

func (_c *Plugin_Prepare_Call) Run(run func(_a0 context.Context)) *Plugin_Prepare_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Plugin_Prepare_Call) Return() *Plugin_Prepare_Call {
	_c.Call.Return()
	return _c
}

func (_c *Plugin_Prepare_Call) RunAndReturn(run func(context.Context)) *Plugin_Prepare_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Plugin) StateRoot() common.Hash {
	ret := _m.Called()
...
// Plugin_StateRoot_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StateRoot'
type Plugin_StateRoot_Call struct {
	*mock.Call
}

// StateRoot is a helper method to define mock.On call
func (_e *Plugin_Expecter) StateRoot() *Plugin_StateRoot_Call {
	return &Plugin_StateRoot_Call{Call: _e.mock.On("StateRoot")}
}

func (_c *Plugin_StateRoot_Call) Run(run func()) *Plugin_StateRoot_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Plugin_StateRoot_Call) Return(_a0 common.Hash) *Plugin_StateRoot_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Plugin_StateRoot_Call) RunAndReturn(run func() common.Hash) *Plugin_StateRoot_Call {
	_c.Call.Return(run)
	return _c
}
