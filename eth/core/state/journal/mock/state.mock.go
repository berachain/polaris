...
func (mock *PluginMock) IterateCode(fn func(addr common.Address, code []byte) bool) {
	if mock.IterateCodeFunc == nil {
		panic("PluginMock.IterateCodeFunc: method is nil but Plugin.IterateCode was just called")
	}
	callInfo := struct {
		Fn func(addr common.Address, code []byte) bool
	}{
...
// Check the length with:
//
//	len(mockedPlugin.IterateCodeCalls())
func (mock *PluginMock) IterateCodeCalls() []struct {
	Fn func(addr common.Address, code []byte) bool
} {
	var calls []struct {
		Fn func(addr common.Address, code []byte) bool
...
func (mock *PluginMock) IterateState(fn func(addr common.Address, key common.Hash, value common.Hash) bool) {
	if mock.IterateStateFunc == nil {
		panic("PluginMock.IterateStateFunc: method is nil but Plugin.IterateState was just called")
	}
	callInfo := struct {
		Fn func(addr common.Address, key common.Hash, value common.Hash) bool
	}{
...
// Check the length with:
//
//	len(mockedPlugin.IterateStateCalls())
func (mock *PluginMock) IterateStateCalls() []struct {
	Fn func(addr common.Address, key common.Hash, value common.Hash) bool
} {
	var calls []struct {
		Fn func(addr common.Address, key common.Hash, value common.Hash) bool
