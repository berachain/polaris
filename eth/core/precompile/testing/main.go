...
func (c *Contract) PrecompileMethods() ethprecompile.Methods {
	return ethprecompile.GeneratePrecompileMethods(bank.BankModuleMetaData.ABI, c)
}
...
func main() {
	...
	pc := NewPrecompileContract(nil, nil)

	methods := pc.PrecompileMethods()

	for _, method := range methods {
		fmt.Println((*method).AbiSig, "maps to", (*method).Execute)
		fmt.Println("====================================")
	}
