...
func (bc *blockchain) GetBlockByNumber(ctx context.Context, number int64) (*types.Block, error) {
...
func (bc *blockchain) GetBlockByHash(ctx context.Context, hash common.Hash) (*types.Block, error) {
