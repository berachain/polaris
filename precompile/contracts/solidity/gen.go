...
//go:generate abigen --pkg generated --abi ./out/staking.sol/StakingEvents.abi.json --bin ./out/staking.sol/StakingEvents.bin --out ./generated/staking_events.abigen.go --type StakingEvents
