...
replace github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20230918183654-51d30dd1a34b
...
require (
	...
	github.com/cosmos/cosmos-sdk v0.50.0-rc.0.0.20230913215410-e5781a9d028d // indirect
