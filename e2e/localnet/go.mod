...
replace github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20230919212829-4a52af33e74d
...
require (
	...
	github.com/cosmos/cosmos-sdk v0.50.0-rc.0.0.20230915171831-2196edacb99d // indirect
