...
./bin/polard start --pruning=nothing "$TRACE" --log_level $LOGLEVEL --api.enabled-unsafe-cors true --api.enable true --api.swagger --minimum-gas-prices=0.0001abera --home "$HOMEDIR"