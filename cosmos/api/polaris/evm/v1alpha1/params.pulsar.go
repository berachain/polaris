...
var (
	...
	fd_Params_eth_genesis protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_Params_eth_genesis = md_Params.Fields().ByName("eth_genesis")
}
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.EthGenesis != "" {
		...
		if !f(fd_Params_eth_genesis, value) {
			return
		}
	}
}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "polaris.evm.v1alpha1.Params.eth_genesis":
		return x.EthGenesis != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "polaris.evm.v1alpha1.Params.eth_genesis":
		panic(fmt.Errorf("field eth_genesis of message polaris.evm.v1alpha1.Params is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: polaris.evm.v1alpha1.Params"))
		}
...
type Params struct {
	...
	// EVM
	EthGenesis string `protobuf:"bytes,3,opt,name=eth_genesis,json=ethGenesis,proto3" json:"eth_genesis,omitempty"`
}
...
func (x *Params) GetEthGenesis() string {
	if x != nil {
		return x.EthGenesis
	}
	return ""
...
var file_polaris_evm_v1alpha1_params_proto_rawDesc = []byte{
	...
	0xb7, 0x01, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x31, 0x0a, 0x09, 0x65, 0x76,
	...
	0x12, 0x37, 0x0a, 0x0b, 0x65, 0x74, 0x68, 0x5f, 0x67, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x16, 0xf2, 0xde, 0x1f, 0x12, 0x79, 0x61, 0x6d, 0x6c, 0x3a,
	0x22, 0x65, 0x74, 0x68, 0x5f, 0x67, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x22, 0x52, 0x0a, 0x65,
	0x74, 0x68, 0x47, 0x65, 0x6e, 0x65, 0x73, 0x69, 0x73, 0x42, 0xcc, 0x01, 0x0a, 0x18, 0x63, 0x6f,
