...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20230426221515-c23aea0cc8dc
...
require (
	...
	pkg.berachain.dev/polaris/eth v0.0.0-20230419230253-478f28600d57
