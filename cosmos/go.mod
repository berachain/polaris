...
replace (
	...
	github.com/ethereum/go-ethereum => github.com/berachain/polaris-geth v0.0.0-20230427152225-86dbeed107fb
...
require (
	...
	pkg.berachain.dev/polaris/contracts v0.0.0-20230427161135-64308689a334
	pkg.berachain.dev/polaris/eth v0.0.0-20230427161135-64308689a334
	pkg.berachain.dev/polaris/lib v0.0.0-20230427161135-64308689a334
)
