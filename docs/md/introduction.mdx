...
To function as a fully fledged Ethereum Virtual Machine, Polaris Ethereum must be integrating into a compatible host. This tutorial assumes that Polaris Ethereum has been integrated into a Cosmos-SDK based chain with the JSON-RPC running on http://0.0.0.0:8545.
