...
>
  ...
  >
    ...
    <span style={{ fontSize: "1.3em", zIndex: -1 }}>
      The New Standard of EVM on Cosmos
    </span>
  </div>
  <canvas
    ref={canvasRef}
...
<div style={{ textAlign: "center" }}>
  <div className="cta-container">
    ...
    <Link className="cta" href="https://www.github.com/berachain/stargazer">
      Github
    </Link>
  </div>
  <div style={{ marginTop: "2rem" }} />
  <Link
    href="https://github.com/berachain/stargazer/blob/main/LICENSE"
    target="_blank"
    style={{
  ...
  >
    Stargazer is licensed under BUSL-1.1 →
  </Link>
</div>
