...
- Basic understanding of the [Polaris' architecture](../../architecture) 
...
- You have [installed
  ...
  walk-through.
- You have a running instance of Polaris EVM. See [Local Machine](../../running-a-node/running-locally) to run Polaris locally.

## Polaris Liquid Staking Smart Contract Example
...
#### 2. Add Configurations For Local Polaris
<Callout emoji="💡">
  Ensure that you have a local instance of Polaris Running. See [Local Machine](../../running-a-node/running-locally) to run Polaris locally.
</Callout>
...
To test the configurations above, let's deploy the generated contract in the "Counter.sol" file to the Polaris localnet:  
```bash
...
#### 9. 🎉 Congratulations! 🎉
Congratulations! You have successfully created and deployed a Liquid Staking contract on Polaris via Foundry!