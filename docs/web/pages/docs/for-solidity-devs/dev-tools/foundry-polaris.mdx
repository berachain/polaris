...
# Using Foundry with Polaris VM EVM
...
<Callout emoji="💡">
  Ensure that you have a local instance of Polaris VM Running. See [Local Machine](../../running-a-node/running-locally) to run Polaris VM locally.
</Callout>
