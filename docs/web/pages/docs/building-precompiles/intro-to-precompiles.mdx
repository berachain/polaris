...
Polaris' unique features rely heavily on its custom precompiled contracts. 
How do precompiled contracts work in Ethereum, and what sets them apart from Polaris' implementation?
...
## What is a Precompiled Contract on Polaris?

In Polaris, a precompiled contract is a custom piece of code that is pre-installed on the chain.
...
This allows a precompiled contract on Polaris can be used to run
...
The possibilities of a Polaris precompiled contract is only limited by the cosmos-sdk application layer and consensus layer.
For information on how to interact with Polaris' precompiled contracts, view the [Precompile Overview](../precompile-overview) section.
