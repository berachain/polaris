## Running a Local Polaris Cosmos-SDK Chain

### From Binary

The easiest way to install a Cosmos-SDK Blockchain running Stargazer is to download a pre-built binary. You can find the latest binaries on the [releases](https://github.com/berachain/stargazer/releases) page.
