# Welcome to PolarisVM

Polaris introduces the new standard of EVM on Cosmos. With improvements to speed, security, reliability,
...
Polaris is a blockchain framework built on top of the Cosmos SDK that offers a full-featured EVM with full
...
Apart from Polaris's focus on interoperability, it also offers a number of other improvements over existing
...
Overall, Polaris is a powerful new framework for developers and users to enjoy. Its seamless integration with other
