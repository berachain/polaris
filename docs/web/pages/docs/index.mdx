...
![](/stargazer-banner.png)

# Introducing Stargazer

Stargazer introduces the new standard of EVM on Cosmos. With improvements to speed, security, reliability,
and an extended set of features, Stargazer will be able to support the next generation of
Cosmos applications while offering a compelling alternative to existing implementations. 

Stargazer is a blockchain framework built on top of the Cosmos SDK that offers a full-featured EVM with full
...
Apart from Stargazer's focus on interoperability, it also offers a number of other improvements over existing
...
Overall, Stargazer is a powerful new framework for developers and users to enjoy. Its seamless integration with other 
