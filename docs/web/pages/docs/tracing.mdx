...
There are two different types of transactions in the Stargazer EVM: value transfers and contract executions. A value transfer simply moves
...
tracing solves. Stargazer's interface traces transactions by re-running them locally and collecting data about precisely what was executed by the EVM.
