...
//nolint:govet,mnd,lll,gomnd,funlen // from sdk.
package cmd
...
Example:
	stargazerd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "stargazerd", "Home directory of the node's daemon configuration")
...
Example:
	stargazerd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := network.DefaultConfig(sdksimapp.NewTestNetworkFixture)
